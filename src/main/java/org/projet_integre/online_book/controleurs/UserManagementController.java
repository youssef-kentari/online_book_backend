...
import org.projet_integre.online_book.services.UsersManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<ReqRes> register(@RequestBody OurUsers reg){
        return ResponseEntity.ok(usersManagementService.register(reg));
    }

    @PostMapping("/auth/login")
    public ResponseEntity<ReqRes> login(@RequestBody User_DTO req){
